...
def instruction():
    ...
    rules = ['Управление:', 'Первый игрок управляет танком на "wasd" и производит выстрел на "e"',
             ...
             'Нажав на кнопку "1 player mode", вы выбираете режим игры:',
             'Vs bots - режим против ботов',
             'Ваша команда красная, команда противников синяя',
             'Ваша задача - убить всех врагов',
             'Vs towers - режим против башен',
             'Ваша задача - сломать все три башни, расположенные на карте',
             'Ваша команда красная, команда башен синяя',
             'После победы или поражения, вам следует нажать пробел для продолжения']
    fon = pygame.transform.scale(load_image('fon.jpg'), (1100, 610))
    screen.blit(fon, (0, 300))
    font = pygame.font.Font(None, 30)
    text_coord = 50
